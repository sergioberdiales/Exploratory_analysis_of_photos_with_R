...
I select just 11 variables from the table and I do some transformations to make the analysis possible.
```{r message = FALSE, warning = FALSE}
...
# Utilizamos la función ymd_hms del paquete lubridate para convertir la variable DateTimeOriginal
# a formato fecha. Convertimos también las variables Lens, ShutterSpeed, Aperture e ISO a formato factor.
