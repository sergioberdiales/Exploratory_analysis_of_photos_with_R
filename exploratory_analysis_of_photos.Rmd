...
I plot the photos in a dot plot, with the month days on the x axis, the hours on the y axis and the lenses by color:

```{r , echo=FALSE}
ggplot(exifbos1, aes(x = day(DateTimeOriginal), hour(DateTimeOriginal), col = LensModel, alpha = 1)) +
geom_jitter()
```
