...
# In order to get the denominator of the shutter speeds minor than 1 second we divide 1 between the ShutterSpeed value
exifbos1 <- exifbos1 %>% mutate(ShutterSpeed_1 = ifelse(as.numeric(ShutterSpeed) < 1, 1/as.numeric(ShutterSpeed), ">=1"))

# We create a new variable 'ShutterSpeed_2" where we copy directly the ShutterSpeed values which are >= 1, and paste 
